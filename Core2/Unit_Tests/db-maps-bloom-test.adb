...
package body DB.Maps.Bloom.Test is
   use DB.Types;

   File_Name : constant String := "unit_test_bloom_map";
   ...
   procedure Inserts (Map : in out Map_Type)
   is
      S : State_Type;
   begin
   ...
   procedure Appends (Map : in out Map_Type)
   is
      S : State_Type;
   begin
      for I in 1 .. Loop_Count loop
   ...
   procedure Delete_Range (Map   : in out Map_Type;
                           First : in     Integer;
                           Last  : in     Integer)
   is
      V : Values.Value_Type;
   ...
   procedure Concurrent_Delete_Range (Map   : in out Map_Type;
                                      First : in     Integer;
                                      Last  : in     Integer)
   is
      V : Values.Value_Type;
