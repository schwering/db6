   ...
   is
      ...
      is
         Transaction : Intermediate_BTrees.RO_Transaction_Type
                     := Intermediate_BTrees.New_RO_Transaction
      ...
      begin
         ...
         begin
            loop
               declare
                  ...
                  State   : Intermediate_BTrees.State_Type;
               begin
                  Intermediate_BTrees.Next(Context.Intermediates, Transaction,
         ...
         Intermediate_BTrees.Finalize_Cursor(Context.Intermediates,
                                             Transaction, Cursor);
